      ...
      <div className="relative ml-auto w-full max-w-lg bg-white shadow-2xl flex flex-col h-full overflow-hidden">
        ...
        {isLoading ? (
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {/* Contact Channels */}
            <div className="px-5 py-4 border-b border-gray-100">
              <div className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Contact & Negotiate</div>
              {/* AI-estimated data disclaimer */}
              <div className="flex items-start gap-2 mb-3 px-3 py-2 rounded-xl bg-amber-50 border border-amber-200">
                <span className="text-amber-500 text-sm shrink-0 mt-0.5">⚠</span>
                <p className="text-[11px] text-amber-700 leading-snug">
                  Contact details are <strong>AI-estimated</strong> — not verified real data. Search the supplier on IndiaMART or Alibaba to confirm before placing orders.
                </p>
              </div>
