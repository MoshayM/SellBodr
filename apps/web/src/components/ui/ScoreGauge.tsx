...
export function RecommendationBadge({ rec, confidence }: { rec: string; confidence?: number }) {
  const cfg: Record<string, BadgeCfg> = {
    launch: {
      ...
      text: '#34d399',
      glow: '0 2px 12px rgba(16,185,129,0.35),inset 0 1px 0 rgba(255,255,255,0.08)',
      icon: '🚀',
      anim: 'animate-badge-launch',
    },
    hold: {
      bg:   'linear-gradient(135deg,rgba(245,158,11,0.22) 0%,rgba(217,119,6,0.14) 100%)',
      border: 'rgba(245,158,11,0.4)',
      text: '#fbbf24',
      glow: '0 2px 10px rgba(245,158,11,0.28)',
      icon: '⏸',
      anim: 'animate-badge-hold',
    },
    reject: {
      bg:   'linear-gradient(135deg,rgba(239,68,68,0.2) 0%,rgba(185,28,28,0.12) 100%)',
      border: 'rgba(239,68,68,0.38)',
      text: '#f87171',
      glow: '0 2px 10px rgba(239,68,68,0.22)',
      icon: '✕',
