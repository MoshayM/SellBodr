    ...
    <div className="min-h-screen bg-[#020817] px-4 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-sm text-white/50 mb-10 p-4 rounded-xl border border-white/8 bg-white/[0.02]">
          <strong className="text-white/70">Plain-English summary:</strong> SellBodr is free to start — create a free account and get up to 5 AI product scans with up to 20 results each, and full opportunity scores. Upgrade to Pro ($19/mo) for unlimited scans, up to 200 results, and private search mode (My Scans — results visible only to you). AI content generation (reports, ads, brand kits, listing copy) uses credits — buy 10 for $5, spend them as you need. By accessing the Service in any capacity you accept these Terms.
        </p>
        ...
        <div className="space-y-8 text-white/70 text-sm leading-relaxed">
          ...
          <Section title="3. Access Tiers &amp; Accounts">
            ...
            <ul className="space-y-2 list-disc pl-5 text-white/60 mb-4">
              <li><strong className="text-white/80">Starter (Free, registered account):</strong> Up to 5 AI product scans (lifetime), up to 20 results per scan, full 7-dimension Opportunity Score, supplier list (up to 10 per product), and profit calculator. No credit card required.</li>
              <li><strong className="text-white/80">Pro ($19/month):</strong> Requires a registered account. Unlocks unlimited AI product scans, up to 200 results per scan, private search mode (results visible only to you, accessible via &quot;My Scans&quot;), premium AI models (Groq + Mistral for public/all searches; Claude + OpenAI additionally for Pro private searches), full supplier list with no cap, real-time supplier search across IndiaMART, Alibaba, and more, plus all dashboard tools. India users are billed in INR via Razorpay.</li>
          ...
          <Section title="4. Subscriptions, Credits &amp; Billing">
            <ul className="space-y-2 list-disc pl-5 text-white/60">
              <li><strong className="text-white/70">Subscription plans</strong> (Starter, Pro) are billed in advance on a monthly basis. International users are billed via Stripe. India users are billed in INR via Razorpay. Starter is permanently free. Pro is $19/month (or the INR equivalent shown at checkout) and may be cancelled at any time.</li>
